  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark ml-auto" id="navigator">
      <div class="container-fluid">
        ...
        <button type="button" class="btn btn-outline-secondary my-1"name="menuOpener" onclick="openNav()"><img src="https://img.icons8.com/material/30/000000/squared-menu.png"></button>
                <div class="btn-group">
                <button type="button" class="btn btn-outline-secondary my-1" onclick="openAutor()"><?php echo "<img class='mx-3' src='https://img.icons8.com/material/30/000000/user-male-circle.png'>"; ?></button>
              </div>
      </div>
    </nav>
